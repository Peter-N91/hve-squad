...
| `full`         | lead, researcher, developer, tester, architect, azure-architect, iac-author, deployer, security, rai, designer, fact-checker, cost-manager, modernizer, scribe                   | You want every deployed capability available                             |
